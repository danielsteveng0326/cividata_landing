    ...
    <div class="section-container relative z-10">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-16">
          ...
          <p class="text-lg text-white/70 max-w-2xl mx-auto mb-12">
          ...
          <a 
            ...
            class="inline-flex items-center btn-primary text-lg px-12 py-5 group"
          >
        ...
        <div class="grid md:grid-cols-3 gap-6 mt-16">
          <div class="glass-card text-center group">
            <div class="w-14 h-14 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-accent/30 transition-colors duration-300">
              <svg class="w-7 h-7 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <div class="text-white/60 text-sm mb-2">Email</div>
            <a href="mailto:info@cividata.com" class="text-white font-medium hover:text-accent transition-colors duration-300">
              info@cividata.com
            </a>
          </div>
          ...
          <div class="glass-card text-center group">
            ...
            <div class="text-white/60 text-sm mb-2">Teléfono</div>
            <a href="https://wa.me/573002701230" target="_blank" class="text-white font-medium hover:text-accent transition-colors duration-300">
              +57 300-123-4567
            </a>
          </div>
          ...
          <div class="glass-card text-center group">
            ...
            <div class="text-white/60 text-sm mb-2">Ubicación</div>
            <div class="text-white font-medium">Medellín, Colombia</div>
          </div>
        </div>
      </div>
    </div>
